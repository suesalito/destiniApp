...
//TODO: Step 7 - Uncomment the lines below to include storyData as a private property in StoryBrain. Hint: You might need to change something in story.dart to make this work.
  ...
  List<Story> _storyData = [
    ...
    Story('He nods slowly, unphased by the question.', 'At least he\'s honest. I\'ll climb in.',
...
//TODO: Step 23 - Use the storyNumber property inside getStory(), getChoice1() and getChoice2()
...
//TODO: Step 8 - Create a method called getStory() that returns the first storyTitle from _storyData.
  ...
  List<int> _lastStates = [3, 4, 5];

  getStory() => _storyData[storyNumber].storyTitle;

//TODO: Step 11 - Create a method called getChoice1() that returns the text for the first choice1 from _storyData.
  getChoice1() => _storyData[storyNumber].choice1;

//TODO: Step 12 - Create a method called getChoice2() that returns the text for the first choice2 from _storyData.
  getChoice2() => _storyData[storyNumber].choice2;

  restart() => storyNumber = 0;

//TODO: Step 25 - Change the storyNumber property into a private property so that only story_brain.dart
//has access to it. You can do this by right clicking on the name (storyNumber) and selecting Refactor -> Rename to make the change across all the places where it's used.

//TODO: Step 16 - Create a property called storyNumber which starts
//with a value of 0. This will be used to track which story the user is currently viewing.

//TODO: Step 17 - Create a method called nextStory(),
//it should not have any outputs but it should have 1 input called choiceNumber which will be the
// choice number (int) made by the user.

//TODO: Step 20 - Download the story plan here:
...
//TODO: Step 21 - Using the story plan, update nextStory() to change the storyNumber depending on the choice made by the user. e.g. if choiceNumber was equal to 1 and the storyNumber is 0, the storyNumber should become 2.
  ...
  void nextStory(int choicenumber) {
    if (storyNumber == 0 && choicenumber == 1) {
      ...
      storyNumber = 4;
    } else if (_lastStates.contains(storyNumber)) {
      print('reset');
      restart();
    }
  }
...
//which checks to see if storyNumber is 0 or 1 or 2 (when both buttons should show choices) and return true if that is the case, else it should return false.
  bool buttonShouldBeVisible() {
    if (_lastStates.contains(storyNumber)) {
      return false;
    } else {
      return true;
    }
